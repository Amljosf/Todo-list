...
function loadFromLocalStorage() {
  try {
    ...
    if (storedProjects) {
      ...
      if (testProject) {
        const dummyTodo1 = new todo(
          "Dummy Todo 1",
          "Description for Dummy Todo 1",
          "2024-04-15",
          1
        );
        const dummyTodo2 = new todo(
          "Dummy Todo 2",
          "Description for Dummy Todo 2",
          "2024-04-16",
          2
        );
...
function renderProjects() {
  ...
  projectsarr.forEach((project) => {
    ...
    deletebuttonpj.style.width = "90px";
    deletebuttonpj.style.height = "30px";
    deletebuttonpj.style.backgroundColor = "#4caf50";
    deletebuttonpj.style.borderRadius = "6px";
    deletebuttonpj.style.border = "none";
    deletebuttonpj.style.color='white'
    deletebuttonpj.style.cursor='pointer';
  
    deletebuttonpj.style.marginRight = "15px";
...
function createprojectfromname(nameofproject) {
  if (nameofproject) {
    const existingProject = projectsarr.find(
      (project) => project.name === nameofproject
    );
    if (existingProject) {
      alert(
